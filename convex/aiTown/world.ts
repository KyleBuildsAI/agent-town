...
export const serializedWorldItem = {
  id: v.string(),
  type: v.string(),
  position: point,
};
export type SerializedWorldItem = ObjectType<typeof serializedWorldItem>;
...
export const serializedWorld = {
  ...
  items: v.optional(v.array(v.object(serializedWorldItem))),
};
